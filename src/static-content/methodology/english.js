export const methodology = {
  text: 'Methodology',
  title1: 'Our Approach',
  paragraph1: 'Based on the framework set in the World Health Organization – International Telecommunication Union’s 2012\n' +
    ...
    '        assess, and benchmark the effective use of digital health.',
  bulletin: {
    title: 'To develop the indicators, the GDHI team:',
    line1: 'Conducted a landscape review of global data available through multilateral organizations.',
    line2: 'Mapped available data by reviewing existing frameworks and tools developed by experts to help practitioners\n' +
      '     and countries assess the strength and maturity of the enabling environment relevant to digital health.',
    line3: 'Convened digital health experts to develop use cases for GDHI and refine and define an initial set\n' +
      '     of recommended indicators into a user-friendly and manageable list.',
  },
  paragraph2: 'List of GDHI Indicators - ',
  seeHere: 'See here',

  title2: 'Data Collection and Verification',
  paragraph3Start: 'The GDHI team works with country partners and Ministry of Health representatives who are\n' +
  ...
  paragraph4: 'The GDHI uses the main indicators in each category to calculate the overall country average.\n' +
    ...
    '        The GDHI enables countries to benchmark themselves against the Global Average or a specific overall phase.'
};
